...
class View:
	...
	"""
	def __init__(self, window_size = 500, board_size = 10) -> None:
	...
	def draw_mark(self, position: Point, mark: Mark, color: str):
		"""
	...
	def draw_end_game(self, positions, mark):
		"""
	...
	def bind_tile_click_listener(self, listener):
		"""
